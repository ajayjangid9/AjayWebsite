      ...
      <div className="row header-bg">
        <div className="col-10 mx-auto">
          ...
          <div className="col-md-6 pt-lg-0 order-2 order-lg-1 mt-5">
            ...
            <p className="heading-p">{props.name}</p>
      ...
      <div className="row">
        <div className="col-10 mx-auto">
          <div className="row">
            ...
            <img src={props.img1} className="img-fluid fade-in mt-3" alt="home-image"style={{width: '90%'}} />
            </div>
          </div>
        </div>
      </div>
...
<div className="progress-name">
  ...
  <div class="progress-bar4" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">60%</div>
          ...
          <img src={props.imgnew} className="animated-new img-fluid" alt="home-image" style={{width: '2%'}} />
        </div>
      </div>
      </div>
    </section>
      ...
      <div className="container-fluid">
        ...
        <div className="col-10 mx-auto">
          <div className="row mt-5">
           ...
           <div className="row">
             <div className="col-lg-6 order-1 order-lg-1">
             <div className=" mt-3 btn-get-started">
              <NavLink to={props.visit3} className="" >
                {props.btname2}
                 </NavLink>
            </div>
             </div>
             <div className="col-lg-6 order-1 order-lg-1">
             <div className=" mt-3 new-btn-started">
              <NavLink to={props.visit3} className="" >
                {props.btname3}
                 </NavLink>
            </div>
            ...
            <div className="col-lg-6 order-1 order-lg-1 ">
            <img src={props.img3} className="img-fluid animated mt-3" alt="home-image" />
            </div>
          </div>
        </div>
        </div>
